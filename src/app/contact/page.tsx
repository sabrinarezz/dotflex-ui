              ...
              {pricingPlans.map((plan, i) => (
                ...
                >
                  <div className="glass p-5 rounded-4 text-center h-100 hover-glow-violet">
                    ...
                    <button className="btn btn-outline-light w-100 rounded-pill py-3">
                      Choose Orbit →
                    </button>
                  </div>
                </motion.div>
            ...
            <div className="row g-5">
              <div className="col-lg-7">
                <div className="glass p-5 rounded-4">
                  ...
                  <form className="row g-4">
                    ...
                    <div className="col-12">
                      <button type="submit" className="btn btn-cosmic w-100 py-4 fs-4 rounded-pill">
              ...
              <div className="col-lg-5">
                <div className="glass p-5 rounded-4 h-100">
                  <h4 className="fw-bold mb-4">Mission Control</h4>
